...
#             subprocess.Popen(["./piper/piper.exe"])             
#         time.sleep(0.1)
# def on_quit(icon, item):
#     tts_thread.join(1)#  a hack to kill the thread
#     icon.stop()
#     sys.exit()
...
pipertts.play_threaded("Hello, this is a test.")

# Simulate some wait time
time.sleep(2)

# Call stop to terminate the playback
pipertts.stop()
